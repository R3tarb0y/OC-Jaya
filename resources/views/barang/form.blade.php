    ...
    <div class="modal-dialog modal-lg" role="document">
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="spesifikasi" class="col-lg-2 col-lg-offset-1 control-label">Specification</label>
                        <div class="col-lg-6">
                            <input type="text" name="spesifikasi" id="spesifikasi" class="form-control" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
